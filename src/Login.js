        ...
        <div className="login">
            ...
            <div className="login_container">
                ...
                <form>
                    ...
                    <h5>Password</h5>
                    <input type="password" value={password} value={password} onChange={(e) => setPassword(e.target.value)}/>
                    <button className="login_signInButton" type="submit" onClick={signIn}>Sign In</button>
                </form>
                <p>
                    By Signing-in your agree to Amazon's
                    conditions of Use & sales. Please
                    see our Privacy Notices, our Cookies Notice
